...
public class Aluguer {
    ...
    */
    public Aluguer(Cliente c1, Proprietario p1, double inicio_x, double inicio_y, double final_x, double final_y, int avaliacaoproprietario, int avaliacaocliente, int avaliacaocarro, double tempo_viagem) {
        this.c1 = c1;
        this.p1 = p1;
