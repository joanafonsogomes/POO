...
public class  Eletrico extends Carro {
    ...
    */
    public Eletrico(ArrayList<Aluguer_final> historico ,String marca,String matricula, String nif,int autonomia, double vel, double preco,int cap, double consu,HashSet<Classificar> a, int clas , double coordx ,double coordy ,boolean pdalg, double bat){
