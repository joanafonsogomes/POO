 ...
 */
    public Registos(HashSet<Cliente> clientes, HashSet<Proprietario> proprietarios, ArrayList<Carro> carross, ArrayList<Aluguer_final> alugueres, HashSet<Classificar> classificacoes) {
        this.clientes = new HashSet<>();
...
//GETTERS E SETTERS
    ...
    public void adicionarClassificacoes( Classificar cl){
   ...
   public Proprietario descobreProp(String email){
    ...
    public Proprietario encontrar_Prop (String nif){
        Iterator<Proprietario> it= proprietarios.iterator();
        Proprietario elem=null;
        boolean r=false;
        while (it.hasNext() && r==false){
