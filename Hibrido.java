...
public class Hibrido extends Carro {
    ...
    */
    public Hibrido(ArrayList<Aluguer> historico ,String marca,String matricula, String nif,int autonomia, double vel, double preco, double consu, int clas , double coordx ,double coordy ,boolean pdalg ,double bat ,double dep){
