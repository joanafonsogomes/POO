...
public class Hibrido extends Carro {
    ...
    */
    public Hibrido(ArrayList<Aluguer_final> historico ,String marca,String matricula, String nif,int autonomia, double vel, double preco,int cap, double consu,HashSet<Classificar> a, int clas , double coordx ,double coordy ,boolean pdalg ,double bat ,double dep){
