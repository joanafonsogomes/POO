...
public class Cliente extends Pessoa{
    ...
    */
    public Cliente(String email, String nome, String password, String nif, String morada, LocalDate data,ArrayList<Aluguer_final> historico,double cx, double cy, double cwalking){
...
//GETTERS E SETTERS      
    ...
    /**
     *Calcula a distancia a que o cliente esta do destino
     */
    public double distanciaDestino(){
      ...
      /**
     *Calcula a distancia a que o carro esta do destino
     */
    public double distanciaDestino_carro(Carro ca){
     ...
     */
     public double custo_estimado (Carro ca){
        double custo;
        double preco= ca.getPreco();
        double distancia = distanciaDestino_carro(ca);
