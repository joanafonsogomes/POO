...
public Carro(float vel, float preco, float consu, int clas , float coordx ,float coordy ,boolean pdalg){
        this.velocidade= vel;
        this.preco = preco;
...
//GETTERS E SETTERS
    ...
    public boolean equals (Object o){
        ...
        Carro that = (Carro) o;
        return (this.velocidade == (that.getVelocidade())
    ...
    public String toString(){
        StringBuffer sb = new StringBuffer("Veiculos: ");
