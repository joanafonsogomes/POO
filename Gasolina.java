...
public class Gasolina extends Carro {
    ...
    */
    public Gasolina(ArrayList<Aluguer> historico ,String marca,String matricula, String nif,int autonomia, double vel, double preco, double consu, int clas , double coordx ,double coordy ,boolean pdalg, double dep){
